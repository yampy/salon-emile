...
- 口調はやわらかく、中高生に話しかけるように。です・ます調で「あなた」と呼びかける。堅苦しい言い回しは日常語に言い換える。
- 身近な例え(部活・友人関係・SNS・受験、有名な漫画・アニメ・スポーツ選手の状況など)を使ってよい。ただし作品のセリフや文章の引用はしない。例えは踏み台であり、主役にしない。軽薄にはしない。
