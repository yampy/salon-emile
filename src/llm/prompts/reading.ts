...
決めつけの禁止(最重要):
- 読者の内面の反応を断定・先取りしない。「詰まりましたよね」「おかしいですよね」「〜と感じたはずです」のような、同意を前提にする言い回しは禁止。付加疑問「〜ですよね」も使わない。
- 問いを出すときは、対立する複数の直観を並置し、どれも正当な出発点として扱う。「即座に〜と思った人も、逆に〜と思った人も、まったく別の答えを持った人もいるでしょう。どの答えもこの回の素材になります」の形を基本とする。
- 読者が想定外の答え(第三の立場)を持つことを歓迎し、それが問いを深める最良の材料であると明示する。哲学は読者の直観を裁かない — 加工する。
