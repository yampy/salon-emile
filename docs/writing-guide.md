...
- **決めつけの禁止(最重要)**: 読者の内面の反応を断定・先取りしない。
  「詰まりましたよね」「おかしいですよね」「〜と感じたはずです」のような同意前提の
  言い回しと付加疑問「〜ですよね」は禁止。問いは複数の直観を並置して開き、読者が
  第三の答えを持つことを歓迎して、それ自体を素材として位置づける。呼びかける
  (personalization)ことと、反応を決めつけることは別物である — 実際の学習者から
  「読者の想定の前提が誤っている」という指摘を受けての明文化(2026-07-18)。
