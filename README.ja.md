...
- **教科書ファースト** — 各回は正典から生成された読み物で開く: つかみ、身近な
  具体例つきの理解のステップ(3〜6)、正典テーゼの一つずつの読み解き、まとめ。
...
- **なんでも質問** — 講座全体をコンテキストに持つグローバルQ&Aチャット。説明+
  身近な例1つに加えて、参考になる回を必ずリンクつきで案内し、関連する repères・
  テーゼを正典IDで指し示す。
...
ビジュアルは「紙とインク」を反転したダークテーマ — 墨地、温白のインク、群青一色、
本文はシステムのサンセリフ体(セリフ・イタリックはロゴタイプの Émile にだけ
残ります)。紙吹雪はありません。
